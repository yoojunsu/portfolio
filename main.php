        ...
        <div class="about-main-wrap">
            <div class="about-my-box">
                ...
                <div class="about-my" id="aboutCareer" data-aos="fade-up" data-aos-delay="200" data-aos-anchor=".about-my-box">
                    ...
                    <div class="about-my-content">
                        <ul class="about-my-career-list">
                            <li class="about-my-content">
                                <h4 class="about-my-career-name">
                                    퍼플스 그룹
                                </h4>
                ...
                <div class="about-my" id="aboutSkils" data-aos="fade-up" data-aos-delay="300" data-aos-anchor=".about-my-box">
                    ...
                    <div class="about-my-content">
                        ...
                        <div class="about-my-skil-detail-box ">
                            <h4 class="about-my-skil-detail-name ">
                                HTML 5
                            </h4>

                            <p class="about-my-skil-detail-desc">
                                시멘틱 요소를 활용하여 웹 페이지의 구조를 더 명확하게 표현하고, <br />
